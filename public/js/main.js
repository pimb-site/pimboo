...
(function ($, api){
	...
	var Plugin = function (el, options){
		...
		this.options  = { // current options
			...
			accept: 0, // accept mime types, "*" Ч unlimited
			...
			maxSize: 0, // max file size, 0 Ч unlimited
		...
		if( !options.url ){
			...
			if( url ){
				...
				this._throw('url Ч is not defined');
			}
		}
