$(document).ready(function () {
	...
	$(".add-question").click(function() {
		...
		+'<div class="answer-text"> <textarea placeholder="Enter text" name="flip_cards['+count_fc+'][answer1]"></textarea></div><div class="answer-checkbox"><div class="tag"><label><input class="checkbox" type="checkbox" name="flip_cards['+count_fc+'][answer_check1]" value="Celebrities"><span class="checkbox-custom"></span><span class="label">Correct answer</span></label></div>'
		...
		+'<div class="answer-checkbox"><div class="tag"><label><input class="checkbox" type="checkbox" name="flip_cards['+count_fc+'][answer_check2]" value="Celebrities"><span class="checkbox-custom"></span><span class="label">Correct answer</span></label></div></div></div></div>'
