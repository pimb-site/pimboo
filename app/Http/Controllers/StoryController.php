	...
	public function postUploadEnd() {
        ...
        $validator = \Validator::make(
            array(
				...
				'Story Content' => $input['form_story']['form_photo_facebook']
            ),
            array(
        ...
        if (!$validator->fails())
        {
            ...
            if(count($errors_array) == 0) {
				...
				$id = \DB::table('posts')->insertGetId(
					...
					'description_footer' => $input['form_story']['form_footer'], 'content' => serialize($content), 'description_image' => $uniqid3.".jpeg", 'image_facebook' => $uniqid4.".jpeg",
