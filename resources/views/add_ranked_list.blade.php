		...
		<div id="choose-upload" class="choose-upload" style="display: none;">
			...
			<div class="modal-upload-column">
				...
				<div class="buttons-img">
					<div class="modal-file-icon" style="float:left;"><div class="select-file" onclick="$('input[name=filedata]')[0].click();"><input type="file" name="filedata" style="display: none"><div class="modal-text-upl">From File</div></div></div>
