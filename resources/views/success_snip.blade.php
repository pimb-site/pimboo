		...
		<div class="body">
			<div class="wrap">
				<div class="succ">
					...
					<div class="group">
						<div class="item butt-for-sharing item-share" data-title="asd12" data-url="{!! url('/snip/') !!}/{{ $id }}" data-type="fb"></div>
						<div class="item butt-for-sharing item-tweet" data-type="tw"></div>
						<div class="item item-embed"></div>
						<div class="item item-more"></div>
					</div>
					<input type="text" value="{!! url('/snip/') !!}/{{ $id }}" />
					<a class="view-item" href="{!! url('/snip/') !!}/{{ $id }}">VIEW ITEM</a>
				</div>
			</div>
		</div>
@endsection
